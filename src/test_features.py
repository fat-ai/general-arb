LLM_FEATURES = {
    "topic_categories": {
        ...
        "us_domestic_elections": ["governor", "senate", "house of representatives", "congress", "electoral college", "presidential", "primary", "nominee", r"\bgop\b", "democrat", "republican", "swing state", "polling", "voter turnout", "ballot", "debate", "inauguration", "executive order", "veto", "filibuster", r"\bscotus\b", "supreme court", "indictment", "verdict", "pardon", "trump", "biden", "harris", "zelenskyy", "say", "saying", "quote", "mention", "presser", "speech"],
        "soccer_and_football": ["premier league", "champions league", r"\buefa\b", r"\bfifa\b", "world cup", "la liga", "bundesliga", r"\bserie a\b", "fa cup", r"\bmls\b", "stoppage time", "penalty", "corner kick", "red card", "yellow card", "clean sheet", "ballon d'or", "striker", "goal scorer", "manchester city", "dragons"],
        "american_football": [r"\bnfl\b", "super bowl", "touchdown", "quarterback", "passing yards", "rushing yards", "receiving yards", "interception", "field goal", r"\bafc\b", r"\bnfc\b", "lombardi", "draft", "heisman", "bowl game", r"\bcfb\b", "juju smith-schuster", r"\bbyu\b", "college football playoff", "tcu", "spread:", "spread "],
        "auto_racing": ["grand prix", r"\bf1\b", "nascar", "formula 1", "liam lawson", "verstappen", "hamilton", "leclerc", "paddock", "podium finish", "chequered flag"],
        "esports_and_gaming": ["league of legends", r"\bdota\b", r"\bcs:go\b", "counter-strike", "valorant", "esports", "liquipedia", "sofascore", "twitch", "steam", "first blood", "baron nashor", "map 1", "map 2", "best of 3", "best of 5", "towers destroyed", "nexus", "avulus", "percival"],
        ...
        "pop_culture_and_awards": ["oscars", "academy award", "grammys", r"\bemmy\b", "golden globe", "box office", "opening weekend", "gross", "rotten tomatoes", "metacritic", "spotify", "youtube views", "billboard", "taylor swift", "eras tour", "person of the year", "time magazine", "shkreli", "mrbeast", "views", "video", "miss universe", "google", "searched", "beyoncé"],
        ...
        "geopolitics_and_conflict": ["un security council", r"\bnato\b", "ceasefire", "military", "border", "sanctions", "treaty", r"\bg7\b", r"\bbrics\b", "missile", "drone", "invasion", "blockade", "deployment", "narendra modi", "thailand"],
    ...
    "structural_tags": {
        "is_time_bound": [r"by \d{4}", r"in \d{4}", r"by (?:jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec)", r"before (?:jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec)", "deadline", "scheduled for", "prior to", "end of", "expire", "week 1", "this week"],
        "is_comparative": ["higher than", "greater than", "more than", "fewer than", "less than", "above", "below", "surpass", "exceed", r"\bo/u\b", "over/under", r"\b5\+\b"],
